...
const game = (event) => {
  ...
  if (gameField[xPosition][yPosition] !== null) return;
  ...
  if (gameResult !== null) {
    alert(gameResult + " is win");
    gameFieldElement.removeEventListener("click", game);
  }
  changePlayer();
};
gameFieldElement.addEventListener("click", game);
